                        ...
                        <ul class="navbar-nav text-right">
                             <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item">
                                        <a href="gallery.html" class="nav-link">Fotos</a>
                                     </li>
                                </ul>
                            </li>
                                <li class="nav-item">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-12 text-center">
                                    <div class="slider-tittle one">
                                        <h1>
                                            Bienvenidos a Virtual Trunk <span>Baúl de Inquietudes</span>
                                        </h1>
                                        <p>
                                            Soy tu amigo de asistencia virtual, permiteme acompañarte en esta nueva experiencia para expresar tus inquietudes brindandote una respuesta automatizada de manera confidencial y segura 
                                        </p>
                                    </div>
                                    <div class="slider-btn bnt1 text-center">
                                       <a href="#" class="box-btn">Empezar</a>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-12 text-center">
                                    <div class="slider-tittle two">
                                        ...
                                        <p>
                                            En este espacio podemos hablar sobre: sexualidad, valores, mitos, equidad de género, enfermedades de transmisión sexual, problemas depresivos y suicidio
    ...
    <section class="home-ragular-course pb-100">
        <div class="container">
            <div class="section-tittle text-center">
                <h2>Baúl de Inquietudes</h2>
                <p>
                    los temas que acá se tratan generalmente son propuestos por los estudiantes
                </p>
            </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-ragular-course">
                        ...
                        <div class="course-content">
                            ...
                            <a href="https://ifeelonline.com/category/terapias-ifeel/familia/" class="border-btn">Leer más</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-ragular-course">
                        ...
                        <div class="course-content">
                            ...
                            <a href="https://ilustrandodudas.com/blog/" class="border-btn">Leer más</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 sst-10">
                    <div class="single-ragular-course">
                        ...
                        <div class="course-content">
                            ...
                            <a href="https://www.educo.org/blog" class="border-btn">Leer más</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="col-lg-12">
                <div class="row">
                    <div class="copy">
                        <p>
                            Copyright @DisOne. Todos los derechos Reservados
                            <a href="mined.gob.nic/" target="_blank"> </a>
                        </p>
                    </div>
                </div>
            </div>
